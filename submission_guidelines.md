...
2. **Commit your work** — including the four filled-in markdown files
   ...
   - We like to see a few meaningful commits rather than one giant squash — it
     helps us follow your thinking. Not required, though.
...
- If you run out of time, leave notes in `SUBMISSION.md` on what you'd do next —
  a clear "here's what I'd tackle with another 30 minutes" is valuable signal.
